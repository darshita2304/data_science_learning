...
app.config['CELERY_BROKER_URL'] = 'pyamqp://guest:guest@localhost:15672/'
app.config['CELERY_RESULT_BACKEND'] = 'pyamqp://guest:guest@localhost:15672/'
...
def upload():
    ...
    path = os.path.join('./uploads', str(file_name))
